document.addEventListener('DOMContentLoaded', function(){
  // 新規投稿・編集ページのフォームを取得
  const businessForm = document.getElementById('new_business');
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'business[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][name="business[images][]"]:last-child');
  ...
  // input要素を取得
  const fileField = document.querySelector('input[type="file"][name="business[images][]"]');
